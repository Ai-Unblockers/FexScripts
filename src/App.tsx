...
function Sidebar({
  ...
  return (
    <aside className="w-[280px] glass-subtle flex flex-col max-lg:hidden">
      ...
      {/* Footer */}
      <div className="border-t border-[rgba(255,255,255,0.06)] px-3 py-3 space-y-2">
        <a
          href="https://discord.gg/sA3DMbCHCB"
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white text-[13px] font-semibold transition-all duration-200 shadow-lg shadow-[#5865F2]/20"
        >
          <svg width="18" height="14" viewBox="0 0 71 55" fill="currentColor">
            <path d="M60.1 4.9C55.6 2.8 50.7 1.3 45.7 0.4C45.6 0.4 45.5 0.4 45.4 0.5C44.8 1.6 44.1 3.1 43.6 4.2C38.2 3.4 32.7 3.4 27.4 4.2C26.9 3.1 26.2 1.6 25.6 0.5C25.5 0.4 25.4 0.4 25.3 0.4C20.3 1.3 15.4 2.8 10.9 4.9C10.8 4.9 10.8 4.9 10.8 5C1.6 18.7 -0.9 32.1 0.3 45.4C0.3 45.5 0.3 45.5 0.4 45.6C6.5 50 12.3 52.7 18.1 54.5C18.2 54.5 18.3 54.5 18.4 54.4C19.7 52.6 20.9 50.6 22 48.5C22 48.4 22 48.3 21.9 48.2C19.9 47.5 18.1 46.6 16.3 45.6C16.2 45.5 16.2 45.3 16.3 45.2C16.7 44.9 17.1 44.6 17.4 44.3C17.5 44.3 17.6 44.3 17.6 44.3C29.3 49.6 41.8 49.6 53.3 44.3C53.4 44.3 53.4 44.3 53.5 44.3C53.8 44.6 54.2 44.9 54.5 45.2C54.7 45.3 54.7 45.5 54.6 45.6C52.8 46.6 51 47.5 49.1 48.2C49 48.3 49 48.4 49 48.5C50 50.6 51.2 52.6 52.6 54.4C52.6 54.5 52.7 54.5 52.8 54.5C58.6 52.7 64.5 50 70.6 45.6C70.6 45.5 70.7 45.5 70.7 45.4C72.2 30.1 68.2 16.8 60.2 5C60.1 4.9 60.1 4.9 60.1 4.9ZM23.7 37.7C20.2 37.7 17.3 34.5 17.3 30.5C17.3 26.5 20.1 23.2 23.7 23.2C27.4 23.2 30.2 26.5 30.1 30.5C30.1 34.5 27.4 37.7 23.7 37.7ZM47.2 37.7C43.7 37.7 40.8 34.5 40.8 30.5C40.8 26.5 43.6 23.2 47.2 23.2C50.9 23.2 53.7 26.5 53.6 30.5C53.6 34.5 50.9 37.7 47.2 37.7Z"/>
          </svg>
          Join Discord
        </a>
        <div className="flex items-center gap-2 text-[11px] text-[#52525b] px-1">
  ...
  return (
    <div className="flex flex-col items-center text-center py-12 animate-slide-up">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white text-[13px] font-semibold transition-all duration-200 shadow-lg shadow-[#5865F2]/20 hover:shadow-[#5865F2]/30 hover:scale-105"
      >
